...
| 第 6 关：图片资产管理 | 历史、收藏、下载、删除、详情、缩略图 | 历史/收藏/删除/下载已实现；缩略图和独立详情页不足 | 部分通过 |
...
| P1 | 图片详情工作流补齐 | 需求要求复制提示词、再次生成、删除二次确认、详情页参数展示，当前主要停留在列表和接口 | 图片详情页可复制 prompt、回填参数再次生成、删除前确认、展示积分和参数 | 第 6 关 |
